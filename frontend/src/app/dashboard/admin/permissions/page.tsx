...
const MODULE_LABELS: Record<string, { title: string; desc: string }> = {
    ...
    eye_exams: { title: 'Eye Examinations', desc: 'Preliminary examinations and clinical eye diagnosis details' },
    surgery: { title: 'Eye Surgery Module', desc: 'Surgical bookings, schedule times, operating rooms, and surgeon allocations' },
    prescriptions: { title: 'Prescriptions logs', desc: 'Optical frame/lens orders and pharmaceutical medicine prescriptions' },
    reports: { title: 'Reports & Analytics', desc: 'Clinical stats, operational records, and financial summary analytics' },
    ...
    logs: { title: 'System Activity Logs', desc: 'Audit trails, database updates, actions tracking, and audit reports' },
