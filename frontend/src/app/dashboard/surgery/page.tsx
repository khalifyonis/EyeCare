...
export default function SurgeryListPage() {
  ...
  return (
    <div className="w-full min-w-0 p-4 sm:p-6 lg:p-8 space-y-6">
      <div>
        <h1 className="text-3xl font-semibold tracking-tight text-slate-900">Eye Surgery</h1>
        <p className="text-slate-600">Surgical procedures management</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link
          ...
          className="rounded-xl border border-slate-200 bg-white p-4 hover:bg-slate-50 transition-colors"
        >
          <div className="flex items-center gap-3">
            <CataractRefIcon className="h-8 w-8" />
            <div>
              <div className="font-semibold text-slate-900">Cataract</div>
              <div className="text-sm font-normal text-slate-900">Schedule Surgery</div>
            </div>
          </div>
        </Link>
        <Link
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-slate-900">LASIK/PRK</div>
              <div className="text-sm font-normal text-slate-900">Refractive procedure</div>
            </div>
          </div>
        </Link>
        <Link
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-slate-900">Retinal</div>
              <div className="text-sm font-normal text-slate-900">Vitreoretinal surgery</div>
            </div>
          </div>
        </Link>
      </div>
          ...
          <TableBody>
            {loading ? (
              ...
              pagedRows.map((r) => {
                ...
                return (
                  <TableRow key={r.id} className="border-slate-100 hover:bg-slate-50/60">
                    <TableCell className="py-4 px-4">
                      <div className="flex items-center gap-3 min-w-[220px]">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-sm text-slate-500 truncate">{srg} | ID: {patientId}</div>
                        </div>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="py-4 px-4">
                      <Badge
                        className={
                          status === 'completed'
                            ? 'rounded-full bg-emerald-100 text-emerald-700 border-0 px-3 py-1 text-xs'
                            : status === 'cancelled'
                              ? 'rounded-full bg-red-100 text-red-700 border-0 px-3 py-1 text-xs'
                              : 'rounded-full bg-sky-100 text-[#0EA5E9] border-0 px-3 py-1 text-xs'
                        }
                      >
                        {status}
                      </Badge>
                    ...
                    <TableCell className="py-4 px-4 whitespace-nowrap">
                      <div className="text-sm font-semibold text-slate-900">{formatShortDate(r.date)}</div>
                      <div className="text-sm text-slate-500">Dr. {surgeonName}</div>
                    </TableCell>
