...
export default function NewPrescriptionPage() {
  ...
  return (
    <div className="w-full min-w-0 p-4 sm:p-5 md:p-6 lg:p-8 space-y-6">
      ...
      <Link href="/dashboard/prescriptions" className="inline-flex items-center gap-2 text-sm text-slate-600 hover:text-slate-900">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6">
        ...
        <div className="mt-6 flex items-center justify-end gap-3">
          <Button variant="ghost" onClick={() => router.push('/dashboard/prescriptions')} disabled={saving}>
            Cancel
          </Button>
          <Button
            onClick={onSave}
