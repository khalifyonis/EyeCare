...
export const ROUTE_ACCESS: AllowedRoute[] = [
    ...
    { prefix: '/dashboard/prescription/optical', roles: ['ADMIN', 'SUPERADMIN', 'RECEPTIONIST', 'DOCTOR', 'OPTICIAN', 'PHARMACIST'] },
    { prefix: '/dashboard/prescription/medicine', roles: ['ADMIN', 'SUPERADMIN', 'RECEPTIONIST', 'DOCTOR', 'PHARMACIST'] },
